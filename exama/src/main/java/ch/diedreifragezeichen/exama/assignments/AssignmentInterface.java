...
public interface AssignmentInterface {
     ...
     * @return percentage of total allowed workload of the Assignment instance on a specific date
     */
    public double getWorkloadValue(Date date);

    /**
     * @param date should be the day from which the days until duedate will be returned
